      ...
      <div className="modal-popup">
        ...
        <div className="modal-body">
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="p-4 bg-gray-50 rounded-2xl">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <span className="font-medium text-[#2C3E50] text-sm">{fromCategory.name}</span>
                  </div>
                  <ArrowRight className="w-4 h-4 text-[#7F8C8D]" />
                  <div className="flex items-center space-x-2">
                    <div 
                      className="w-4 h-4 rounded-full" 
                      style={{ backgroundColor: toCategory.color }}
                    />
                    <span className="font-medium text-[#2C3E50] text-sm">{toCategory.name}</span>
                  </div>
                </div>
              </div>
            )}
            ...
            <div>
              <label className="block text-sm font-medium text-[#2C3E50] mb-2">Motivo da Transferência</label>
              <textarea
                value={formData.description}
                onChange={handleChange('description')}
                placeholder="Ex: Sobrou do mês anterior, ajuste de categoria..."
