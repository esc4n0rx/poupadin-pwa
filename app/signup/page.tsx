      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="flex justify-center mb-8">
          <div className="w-48 h-48">
            <img src="/person-with-phone-financial-app-illustration.jpg" alt="Signup illustration" className="w-full h-full object-contain" />
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Button
            ...
            variant="outline"
            className="w-full h-14 text-base font-medium rounded-2xl border-2 bg-transparent"
          >
